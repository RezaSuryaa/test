...
$sql = "SELECT tb_transaksi.id_transaksi, tb_pelanggan.id_pelanggan, tb_buku.id_buku, tb_pelanggan.nama_pelanggan, tb_buku.nama_buku, tb_transaksi.jumlah, tb_transaksi.tanggal, tb_transaksi.harga, tb_transaksi.total_pembayaran FROM tb_pelanggan INNER JOIN tb_transaksi ON tb_pelanggan.id_pelanggan = tb_transaksi.id_pelanggan INNER JOIN tb_buku ON tb_buku.id_buku = tb_transaksi.id_buku WHERE tb_transaksi.id_transaksi = '$id_transaksi'";
